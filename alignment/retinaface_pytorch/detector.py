...
from retinaface import load_retinaface_mbnet,RetinaFace_MobileNet
...
class Retinaface_Detector(object):
    def __init__(self):
        ...
        self.model.load_state_dict(torch.load("alignment/retinaface_pytorch/checkpoint.pt")['state_dict'])
    ...
    def detect(self, img):
        ...
        output = self.model(im_tensor.to(self.device))
